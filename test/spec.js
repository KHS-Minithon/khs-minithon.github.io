...
casper.test.begin('Important Links', function suite(test) {
    ...
    casper.start("http://khs-minithon.github.io/website/", function() {
        ...
        test.assertElementCount('.navbar-nav li', 7, '7 Sections in Navigation Bar Found');
            ...
            // Partners
            test.assertEquals(this.fetchText('.navbar-nav li:nth-child(6) a'), "Partners", "Correct Navigation-Partners Text");
            test.assertEquals(this.getElementAttribute('.navbar-nav li:nth-child(6) a', 'href'), '#partners-section', 'Correct Navigation-Partners Link');

            // Social
            test.assertEquals(this.fetchText('.navbar-nav li:nth-child(6) a'), "Social", "Correct Navigation-Social Text");
            test.assertEquals(this.getElementAttribute('.navbar-nav li:nth-child(6) a', 'href'), '#social-section', 'Correct Navigation-Social Link');
